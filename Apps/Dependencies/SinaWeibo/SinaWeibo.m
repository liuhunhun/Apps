...
- (BOOL)isLoggedIn
{
    ...
    return [sinaweiboInfo objectForKey:@"UserIDKey"] && [sinaweiboInfo objectForKey:@"AccessTokenKey"] && [sinaweiboInfo objectForKey:@"ExpirationDateKey"];
}
...
- (BOOL)isAuthorizeExpired
{
    ...
    return ([now compare:[sinaweiboInfo objectForKey:@"ExpirationDateKey"]] == NSOrderedDescending);
}
